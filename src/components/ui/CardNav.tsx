  ...
  return (
    <>
      {isExpanded &&
        createPortal(
          <div
            className="bg-background/30 fixed inset-0 z-[90] backdrop-blur-[2px]"
            aria-hidden="true"
          />,
          document.body,
        )}
      ...
      >
        <nav
          ...
          className={`card-nav ${
            isExpanded ? "open" : ""
          } from-card via-card to-primary/85 shadow-primary/30 relative z-20 block h-[60px] overflow-hidden rounded-2xl border-white/15 bg-linear-to-br shadow-2xl backdrop-blur-xl will-change-[height]`}
        >
