  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "rgba(14, 164, 231,0.1) 0 1px 2px, rgba(14, 164, 231,0.1) 0 2px 4px, rgba(14, 164, 231,0.1) 0 4px 8px, rgba(14, 164, 231,0.1) 0 8px 16px, rgba(14, 164, 231,0.1) 0 16px 32px, rgba(14, 164, 231,0.1) 0 32px 64px",
      }}
    >
      ...
      <div
        ...
        style={{
          border: "1px solid #0ea4e7",
          background: [
            `linear-gradient(0 0 100%) padding-box`,
        ...
        <span
          ...
          style={{
            ...
            boxShadow: buildBoxShadow(
              theme === "dark" ? glowColorDark : glowColor,
              glowIntensity,
            ),
          }}
        />
